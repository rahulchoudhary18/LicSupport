...
async def start(client, message):
    ...
    if await check_user_joined_channels(client, user_id, config.REQUIRED_CHANNEL_IDS):
        welcome_message = (
            ...
            "**☞ https://www.licwin.com/?sharecode=8213694**\n\n"
            "**👋 Eᴀʀɴ Dᴀɪʟʏ 2000₹-5000₹ Vɪᴀ Pʟᴀʏɪɴɢ Eᴀsʏ Gᴀᴍᴇs💰**\n\n"
            "**ᴛʜᴀɴᴋ ʏᴏᴜ 😘😘**\n"
            "**────────────────────────────**"
        )
          
        photo_url = "https://telegra.ph/file/bfe10e4f657bb41c0112b.jpg"
        reply_markup = InlineKeyboardMarkup([
            [InlineKeyboardButton("ʀᴇᴄʜᴀʀɢᴇ / ᴡɪᴛʜᴅʀᴀᴡᴀʟ ɪꜱꜱᴜᴇ", url="https://t.me/JessicaLIC")],
            [InlineKeyboardButton("ᴠɪᴘ ᴄʜᴀɴɴᴇʟ", url="https://t.me/+FcKopz8L4zg3ZjU1")],
...
async def on_callback_query(client, callback_query):
    ...
    if data == "check_joined":
        ...
        welcome_message = (
            ...
            "**🤝 मैं आपकी कैसे मदद कर सकती हूँ?**\n\n"
            "**💡ꜰɪʀꜱᴛ ꜱᴇɴᴅ ᴍᴇ ʏᴏᴜʀ ᴜɪᴅ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ɪꜰ ʏᴏᴜ ɴᴏᴛ ʀᴇɢɪꜱᴛᴇʀ ᴜɴᴅᴇʀ ᴏꜰꜰɪᴄɪᴀʟ(ᴍʏ) ʟɪɴᴋ ᴏʀ ɪɴ ᴍʏ ᴛᴇᴀᴍ ᴛʜᴇɴ ᴅᴏɴ'ᴛ ᴡᴀꜱᴛᴇ ᴏᴜʀ ᴛɪᴍᴇ.**\n\n"
            "**☞ Rᴇɢɪsᴛᴇʀ Wɪᴛʜ https://www.licwin.com/?sharecode=8213694**\n\n"
            "**👋 Eᴀʀɴ Dᴀɪʟʏ 2000₹-5000₹ Vɪᴀ Pʟᴀʏɪɴɢ Eᴀsʏ Gᴀᴍᴇs💰**\n\n"
            "**ᴛʜᴀɴᴋ ʏᴏᴜ 😘😘**\n"
            "**────────────────────────────**"
        )
